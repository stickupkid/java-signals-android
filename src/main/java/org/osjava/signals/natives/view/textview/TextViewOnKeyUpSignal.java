...
public class TextViewOnKeyUpSignal extends NativeSignalImpl4<TextView, Editable, Integer, KeyEvent> {
	 ...
	 */
	private TextViewOnKeyUpSignal(TextView target, int inputType) {
		setTarget(target);
	...
	/**
	 * Create a newInstance of TextViewOnKeyUpSignal
	 * 
	 * @return {@link TextViewOnKeyUpSignal}
	 */
	@SuppressWarnings("unchecked")
	public static TextViewOnKeyUpSignal newInstance() {
		return new TextViewOnKeyUpSignal();
	}
	 ...
	 * @return {@link TextViewOnKeyUpSignal}
	 */
	public static TextViewOnKeyUpSignal newInstance(final TextView target, final int inputType) {
		return new TextViewOnKeyUpSignal(target, inputType);
	}
